...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    private static final boolean OPTS_INPUT = SystemProperties.getBoolean("persist.inputopts.enable",false);
    private static final String MOVE_TOUCH_SLOP = SystemProperties.get("persist.inputopts.movetouchslop","0.6");
